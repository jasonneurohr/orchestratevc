...
class TestCiscoExpressway(unittest.TestCase):

  def setUp(self):
    self.test_address = "dummy"
    self.exp = orchestratevc.CiscoExpressway(self.test_address, "dummy", "dummy")
  ...
  def test_get_serial(self):
    ...
    xml_buffered_reader = io.BufferedReader(io.open("test/status.xml", "rb"))
